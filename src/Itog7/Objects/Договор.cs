...
namespace IIS.Itog7
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog7.Статус fСтатус;
        
        private IIS.Itog7.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Itog7.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.Itog7.Клиент fКлиент;
        
        private IIS.Itog7.Длительность fДлительность;
        ...
        public virtual IIS.Itog7.Статус Статус
        {
            get
            {
                ...
                IIS.Itog7.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog7.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog7.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog7.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog7.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Itog7.Длительность Длительность
        {
            get
            {
                ...
                IIS.Itog7.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog7.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog7.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog7.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog7.Договор));
                }
            }
        }
    }
