    ...
    public class ДирОтдПоРабСКл : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДирОтдПоРабСКлE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДирОтдПоРабСКлE", typeof(IIS.Itog7.ДирОтдПоРабСКл));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДирОтдПоРабСКлL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДирОтдПоРабСКлL", typeof(IIS.Itog7.ДирОтдПоРабСКл));
                }
            }
        }
    }
