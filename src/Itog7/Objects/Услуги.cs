...
namespace IIS.Itog7
{
    ...
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog7.Услуга fНаименование;
        
        private IIS.Itog7.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.Itog7.Услуга Наименование
        {
            get
            {
                ...
                IIS.Itog7.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.Itog7.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.Itog7.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.Itog7.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.Itog7.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.Itog7.Услуги));
                }
            }
        }
    }
