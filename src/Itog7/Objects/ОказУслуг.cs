...
namespace IIS.Itog7
{
    ...
    [View("ОказУслугE", new string[] {
            ...
            "Договор",
            "Договор.Номер",
            "Договор.Длительность",
            "Договор.Длительность.Номер",
            "Услуги",
            "Услуги.Наименование"})]
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog7.Договор fДоговор;
        
        private IIS.Itog7.Услуги fУслуги;
        
        private IIS.Itog7.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Itog7.Договор Договор
        {
            get
            {
                ...
                IIS.Itog7.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Itog7.Услуги Услуги
        {
            get
            {
                ...
                IIS.Itog7.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itog7.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Itog7.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Itog7.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Itog7.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itog7.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Itog7.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Itog7.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Itog7.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Itog7.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itog7.ОказУслуг dataobject)
        {
