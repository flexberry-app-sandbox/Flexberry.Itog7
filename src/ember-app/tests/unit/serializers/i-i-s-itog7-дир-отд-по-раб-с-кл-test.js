...
moduleForModel('i-i-s-itog7-дир-отд-по-раб-с-кл', 'Unit | Serializer | i-i-s-itog7-дир-отд-по-раб-с-кл', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itog7-дир-отд-по-раб-с-кл',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

    'transform:i-i-s-itog7-статус',
    'transform:i-i-s-itog7-тип-договора',
    'transform:i-i-s-itog7-услуга',
